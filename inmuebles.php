...
<div id="wrapper">
    ...
    <?php 
        ...
        <div id="content">
        	  ...
        	  <?php
				...
				while ($fila=mysql_fetch_array($resul))
				{
					echo "<tr>
							...
							<td>".$fila["banco"]."</td>
							<td>".$fila["precio"]."</td>
							<td><a onclick='return confirmarborrado()' href='borrarin.php?numin=".$fila["numin"]."'><img src='images/eliminar.png' width='20' /></a></td>
						 </tr>";
        	...
        	<form id="form1" name="form1" method="post" action="insertarin.php">
