...
if (isset($_POST["precio"]))
 ...
 /* if ($haysuperficie) {
     $consulta = $consulta." superficie = ".$_POST["superficie"]." ";
    	 ...
    	 $consulta." banco = 0 = '".$_POST["banco"]."' ";
				...
				{	
					echo "<tr>
							...
							<td>".$fila["banco"]."</td>
							<td>".$fila["precio"]."</td>							
							<td><a onclick='return confirmarborrado()' href='borrarinusu.php?numin=".utf8_encode($fila["numin"])."'><img src='images/eliminar.png' width='20' /></a></td>
						 </tr>";
				...
				/*$rango1=" superficie =< 50";
						
				$rango2=" superficie BETWEEN 50
						AND 100 ";
						
				$rango3=" superficie BETWEEN 100
						AND 150 ";*/
			...
			if (isset($_SESSION["error"]))
	{
		...
		unset($_SESSION["error"]);
            ...
            <div id="stylized" class="mysearch">
            <form id="form" name="form" method="post" action="busqueda2.php">
                    <h1>MI BÚSQUEDA</h1>
                    <p></p>
